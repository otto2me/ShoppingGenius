...
import com.shoppinggenius.app.ui.ShoppingGeniusTransition
...
fun NavGraphBuilder.groceryListNestedNavigation(
    ...
    composable(
        ...
        enterTransition = {
            when (initialState.destination.route) {
                CATEGORY_ROUTE -> ShoppingGeniusTransition.SlideInHorizontallyEnterBackward
                GROCERY_LISTS_DASHBOARD_ROUTE -> ShoppingGeniusTransition.SlideInHorizontallyEnterForward
                else -> EnterTransition.None
            }
        },
        exitTransition = {
            when (targetState.destination.route) {
                CATEGORY_ROUTE -> ShoppingGeniusTransition.SlideOutHorizontallyExitBackward
                GROCERY_LISTS_DASHBOARD_ROUTE -> ShoppingGeniusTransition.SlideOutHorizontallyExitForward
    ...
    composable(
        ...
        enterTransition = {
            ShoppingGeniusTransition.SlideInHorizontallyEnterForward
        },
        exitTransition = {
            ShoppingGeniusTransition.SlideOutHorizontallyExitForward
        }
    ) { backStackEntry ->
        CategoryRoute(
