...
package com.rendox.shoppinggenius.ui.components.scrollbar
...
import com.rendox.shoppinggenius.ui.components.scrollbar.ThumbState.Active
import com.rendox.shoppinggenius.ui.components.scrollbar.ThumbState.Dormant
import com.rendox.shoppinggenius.ui.components.scrollbar.ThumbState.Inactive
...
private fun ScrollableState.DraggableScrollbarThumb(
    ...
    Box(
        modifier = Modifier
            .run {
                when (orientation) {
                    Vertical -> width(6.dp).fillMaxHeight()
