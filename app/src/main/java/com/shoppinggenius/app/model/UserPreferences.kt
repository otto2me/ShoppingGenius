...
data class UserPreferences(
    ...
    val groupByCategoryInListMode: Boolean = DEFAULT_USER_PREFERENCES.groupByCategoryInListMode,
    val useThreeLineTodoEntries: Boolean = DEFAULT_USER_PREFERENCES.useThreeLineTodoEntries,
...
val DEFAULT_USER_PREFERENCES = UserPreferences(
    ...
    useListViewForGroceries = true,
    groupByCategoryInListMode = true,
    useThreeLineTodoEntries = true,
    widgetBackgroundOpacityPercent = 30,
    selectedTheme = ShoppingGeniusColorScheme.CyanColorScheme,
